...
import userimg from '../../assets/images/icon-image.png'
...
const Header = () => {
  ...
  return  <header className=" flex items-center sticky__header" ref={headerRef}>
    <div className="container">
      <div className="flex items-center justify-between">
        ...
        {/*_____________nav right______________*/}
